...
public static void startRecording(String methodName) throws Exception {
    ...
    /*screenRecorder = new MyScreenRecorder(gc, captureSize,
                    ...
                    new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, "black", FrameRateKey, Rational.valueOf(50)),
    ...
    screenRecorder = new MyScreenRecorder(gc, captureSize,
                     ...
                     new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_MJPG,
                               ...
                               Rational.valueOf(40), QualityKey, 1.0f, KeyFrameIntervalKey, 15 * 60),
